...
# --- 2. 데이터 정의 ---
GEOMETRY_UNITS = {
        "I. 이차곡선": ["포물선", "타원", "쌍곡선", "이차곡선의 접선의 방정식"],

    "II. 공간도형과 공간좌표": ["직선과 평면의 위치 관계", "삼수선의 정리", "정사영", "좌표공간", "선분의 내분점", "구의 방정식"],

    "III. 벡터": ["벡터", "벡터의 덧셈과 뺄셈", "벡터의 실수배", "위치벡터", "벡터의 성분", "벡터의 내적", "직선의 방정식", "평면과 구의 방정식"]
}
